defmodule PhoenixChatgptPluginWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixChatgptPluginWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixChatgptPluginWeb.Gettext, "errors", msg, opts)
    end
  end
